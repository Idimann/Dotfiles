...
--Organisation
    ...
    require('DefaultConfig.plugins.harpoon')

--Beauty
    --require('DefaultConfig.plugins.lualine')
    require('DefaultConfig.plugins.treesitter')
    require('DefaultConfig.plugins.zen')
    require('DefaultConfig.plugins.rainbow-braces')
